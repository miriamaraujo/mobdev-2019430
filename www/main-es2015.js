...
const routes = [
    ...
    {
        path: 'camera',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-camera-camera-module */ "camera-camera-module").then(__webpack_require__.bind(null, /*! ./pages/camera/camera.module */ "./src/app/pages/camera/camera.module.ts")).then(m => m.CameraPageModule)
    }
];
...
module.exports = __webpack_require__(/*! /workspace/mobdev-2019430/src/main.ts */"./src/main.ts");
